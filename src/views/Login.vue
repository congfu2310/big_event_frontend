...
//用于注册的数据模型
//注意：registerData是一个响应式数据，需要.value才可以获取到值
...
//调用后台接口
import { userRegsiterService, userLoginService } from "@/api/user.js";
...
const register = async () => {
  let result = await userRegsiterService(registerData.value);
  //   alert("注册成功！");
